...
gulp.task('watch', () => {
  ...
  watch('src/{styles,blocks}/**/*.styl', () => {
    runSequence(['styles', 'styles:lint'], () => bs.reload('assets/styles/main.min.css'));
  });
  watch('src/icons/**/*.svg', () => runSequence('icons', bs.reload));
  watch('src/{pages,blocks}/**/*.pug', () => runSequence('templates', bs.reload)).on('all', (event, filepath) => {
